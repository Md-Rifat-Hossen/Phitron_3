...
void maxi_min_val(node*head)
{
    ...
    cout << endl<<"The bigest element :"<<max <<endl<< endl;
}
void Middle_node(node*head)
{
    ...
    cout <<endl<< "Find the moddle Node: " <<p<<endl<< endl;
...
int main()
{
    ...
    cout << endl<<"10.Find the max Element" << endl;
    cout << endl<<"11.Find the middle Node" << endl;
    cout <<endl<< "12.Exit " <<endl<< endl;
